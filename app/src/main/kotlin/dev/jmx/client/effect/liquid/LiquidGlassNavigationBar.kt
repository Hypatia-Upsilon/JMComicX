...
package dev.jmx.client.effect.liquid
...
import dev.jmx.client.effect.liquid.animation.DampedDragAnimation
import dev.jmx.client.effect.liquid.animation.InteractiveHighlight
...
// iOS 风格底栏的尺寸基准。整条胶囊的高度、指示器高度、按压放大目标是联动的：
// 指示器要正好落在胶囊的 4dp 内边距里（PANEL - 2 * 4dp），按压时的放大量保持原来的绝对值
// （原基准 56 → 78，即 +22dp），不随基准变大而按比例夸张。
private val IOS_NAV_PANEL_HEIGHT = 62.dp
private val IOS_NAV_INDICATOR_HEIGHT = 54.dp
private const val IOS_NAV_PANEL_WIDTH_FRACTION = 0.7f
private const val IOS_NAV_PRESSED_SCALE = 84f / 62f
private val IOS_NAV_ICON_SIZE = 24.dp
private val IOS_NAV_LABEL_SIZE = 12.sp
...
internal fun IosLiquidGlassNavigationBar(
    ...
    val dampedDrag = remember(animationScope, tabsCount, density, isLtr) {
        DampedDragAnimation(
            ...
            initialScale = 1f,
            pressedScale = IOS_NAV_PRESSED_SCALE,
            canDrag = { position ->
    ...
    val bottomPaddingValue = when (platform()) {
        Platform.IOS -> 20.dp
            ...
            if (navBarBottomPadding != 0.dp) 8.dp + navBarBottomPadding else 24.dp
        }
    }
        ...
        items.forEachIndexed { index, item ->
            Column(
                ...
                BadgedBox(badge = { badge(index)?.invoke() }) {
                    Icon(
                        modifier = Modifier.size(IOS_NAV_ICON_SIZE),
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                ...
                .fillMaxWidth(IOS_NAV_PANEL_WIDTH_FRACTION),
                ...
                CompositionLocalProvider(
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .height(IOS_NAV_INDICATOR_HEIGHT)
